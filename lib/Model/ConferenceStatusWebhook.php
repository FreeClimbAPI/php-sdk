...
/**
 * ConferenceStatusWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class ConferenceStatusWebhook extends Webhook
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConferenceStatusWebhook';
    ...
    */
     ...
     * Sets request_type
     *
     * @param string|null $request_type Context or reason why this request is being made. Will be conferenceRecordingStatus - The statusCallbackUrl request includes Recording information for a Conference that ended.
     *
     * @return self
     */
     ...
     * Sets recording_url
     *
     * @param string|null $recording_url The URL of the Conference’s recorded audio. Populated only if a Recording exists and the Conference was emptied. Present only if statusCallbackUrl is being invoked.
     *
     * @return self
     */
     ...
     * Sets recording_id
     *
     * @param string|null $recording_id The unique ID of the Recording from this Conference. Populated only if a Recording exists and the Conference was emptied. Present only if statusCallbackUrl is being invoked.
     *
     * @return self
     */
    public function setRecordingId($recording_id)
    {
        if (is_null($recording_id)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('recording_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param int|null $recording_duration_sec The duration of the recorded audio rounded up to the nearest second (in seconds). Populated only if a Recording exists and the Conference was emptied. Present only if statusCallbackUrl is being invoked.
     *
     * @return self
     */
    public function setRecordingDurationSec($recording_duration_sec)
    {
        if (is_null($recording_duration_sec)) {
            array_push($this->openAPINullablesSetToNull, 'recording_duration_sec');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('recording_duration_sec', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public static function deserialize(string $payload) {
        ...
        return ObjectSerializer::deserialize($content, '\FreeClimb\Api\Model\ConferenceStatusWebhook', []);
    }
}
