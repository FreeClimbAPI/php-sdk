...
/**
 * RedirectWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class RedirectWebhook extends Webhook
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RedirectWebhook';
    ...
    */
     ...
     * Sets request_type
     *
     * @param string|null $request_type Context or reason why this request is being made. Will be redirect - The Redirect command is executing and its actionUrl is being invoked.
     *
     * @return self
     */
    ...
    public static function deserialize(string $payload) {
        ...
        return ObjectSerializer::deserialize($content, '\FreeClimb\Api\Model\RedirectWebhook', []);
    }
}
