 ...
 */
class SayNeural implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SayNeural';
    ...
    protected static $openAPITypes = [
        ...
        'loop' => 'int',
        'privacy_mode' => 'bool',
        'engine' => '\FreeClimb\Api\Model\SayNeuralEngine'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('privacy_mode', $data ?? [], false);
    ...
    */
     ...
     * Sets loop
     *
     * @param int|null $loop Number of times the text is said. Specifying '0' causes the `SayNeural` action to loop until the Call is hung up.
     *
     * @return self
     */
     ...
     * Gets engine
     *
     * @return \FreeClimb\Api\Model\SayNeuralEngine
     */
     ...
     * Sets engine
     *
     * @param \FreeClimb\Api\Model\SayNeuralEngine $engine engine
     *
     * @return self
     */
