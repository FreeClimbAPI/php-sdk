...
/**
 * QueueWaitWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class QueueWaitWebhook extends Webhook
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QueueWaitWebhook';
    ...
    protected static $setters = [
        ...
        'current_queue_size' => 'setCurrentQueueSize'
    ];
    ...
    protected static $getters = [
        ...
        'current_queue_size' => 'getCurrentQueueSize'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('current_queue_size', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets request_type
     *
     * @param string|null $request_type Context or reason why this request is being made. Will be queueWait - A queued call is requesting instructions to execute during the wait in the queue and the corresponding waitUrl is being invoked.
     *
     * @return self
     */
     ...
     * Sets queue_position
     *
     * @param string|null $queue_position Current queue position of the enqueued Call.
     *
     * @return self
     */
    ...
    public function setQueueTime($queue_time)
    {
        if (is_null($queue_time)) {
            throw new \InvalidArgumentException('non-nullable queue_time cannot be null');
        }
    ...
    /**
     * Gets current_queue_size
     *
     * @return int|null
     */
    public function getCurrentQueueSize()
    {
        return $this->container['current_queue_size'];
    }

    /**
     * Sets current_queue_size
     *
     * @param int|null $current_queue_size Current number of enqueued Calls in this Queue.
     *
     * @return self
     */
    public function setCurrentQueueSize($current_queue_size)
    {
        if (is_null($current_queue_size)) {
            throw new \InvalidArgumentException('non-nullable current_queue_size cannot be null');
        }
        $this->container['current_queue_size'] = $current_queue_size;
    ...
    public static function deserialize(string $payload) {
        ...
        return ObjectSerializer::deserialize($content, '\FreeClimb\Api\Model\QueueWaitWebhook', []);
    }
}
