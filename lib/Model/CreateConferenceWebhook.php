...
/**
 * CreateConferenceWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateConferenceWebhook extends Webhook
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateConferenceWebhook';
    ...
    */
     ...
     * Sets request_type
     *
     * @param string|null $request_type Context or reason why this request is being made. Will be createConference - A Conference has been created and its statusCallbackUrl or actionUrl is being invoked.
     *
     * @return self
     */
    ...
    public static function deserialize(string $payload) {
        ...
        return ObjectSerializer::deserialize($content, '\FreeClimb\Api\Model\CreateConferenceWebhook', []);
    }
}
