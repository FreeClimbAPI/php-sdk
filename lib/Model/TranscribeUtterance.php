...
class TranscribeUtterance extends PerclCommand
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('play_beep', $data ?? [], false);
        $this->setIfExists('record', $data ?? [], null);
        $this->setIfExists('privacy_for_logging', $data ?? [], false);
        $this->setIfExists('privacy_for_recording', $data ?? [], false);
    ...
    */
     ...
     * Sets prompts
     *
     * @param \FreeClimb\Api\Model\PerclCommand[]|null $prompts prompts
     *
     * @return self
     */
