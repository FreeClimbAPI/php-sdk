...
class GetDigits extends PerclCommand
{
    ...
    protected static array $openAPINullables = [
        'action_url' => false,
        'digit_timeout_ms' => false,
        'finish_on_key' => false,
        'flush_buffer' => false,
        'initial_timeout_ms' => false,
        'max_digits' => false,
        'min_digits' => false,
        'prompts' => false,
        'privacy_mode' => false
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('digit_timeout_ms', $data ?? [], null);
        $this->setIfExists('finish_on_key', $data ?? [], null);
        $this->setIfExists('flush_buffer', $data ?? [], null);
        $this->setIfExists('initial_timeout_ms', $data ?? [], null);
        $this->setIfExists('max_digits', $data ?? [], null);
        $this->setIfExists('min_digits', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($digit_timeout_ms)) {
            throw new \InvalidArgumentException('non-nullable digit_timeout_ms cannot be null');
        }
    ...
    {
        if (is_null($flush_buffer)) {
            throw new \InvalidArgumentException('non-nullable flush_buffer cannot be null');
        }
    ...
    {
        if (is_null($initial_timeout_ms)) {
            throw new \InvalidArgumentException('non-nullable initial_timeout_ms cannot be null');
        }
    ...
    {
        if (is_null($min_digits)) {
            throw new \InvalidArgumentException('non-nullable min_digits cannot be null');
        }
