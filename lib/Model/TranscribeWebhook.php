...
class TranscribeWebhook extends Webhook
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['recording_duration_ms'] = $data['recording_duration_ms'] ?? null;
        $this->container['term_reason'] = $data['term_reason'] ?? null;
        $this->container['record_term_reason'] = $data['record_term_reason'] ?? null;
        $this->container['digit'] = $data['digit'] ?? null;
        $this->container['privacy_for_logging'] = $data['privacy_for_logging'] ?? null;
        $this->container['privacy_for_recording'] = $data['privacy_for_recording'] ?? null;
        $this->container['barge_in_reason'] = $data['barge_in_reason'] ?? null;
        $this->container['barged_in_prompt_no'] = $data['barged_in_prompt_no'] ?? null;
        $this->container['barged_in_prompt_ms'] = $data['barged_in_prompt_ms'] ?? null;
        $this->container['barged_in_prompt_loop_no'] = $data['barged_in_prompt_loop_no'] ?? null;
        $this->container['barge_in_time_ms'] = $data['barge_in_time_ms'] ?? null;
        $this->container['transcript'] = $data['transcript'] ?? null;
        $this->container['transcribe_reason'] = $data['transcribe_reason'] ?? null;
        $this->container['transcription_duration_ms'] = $data['transcription_duration_ms'] ?? null;
    }
