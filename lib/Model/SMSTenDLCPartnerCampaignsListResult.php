...
class SMSTenDLCPartnerCampaignsListResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('partner_campaigns', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($partner_campaigns)) {
            array_push($this->openAPINullablesSetToNull, 'partner_campaigns');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('partner_campaigns', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
