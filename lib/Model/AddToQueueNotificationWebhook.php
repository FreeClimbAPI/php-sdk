...
/**
 * AddToQueueNotificationWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class AddToQueueNotificationWebhook extends Webhook
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddToQueueNotificationWebhook';
    ...
    */
     ...
     * Sets request_type
     *
     * @param string|null $request_type Context or reason why this request is being made. Will be addToQueueNotification - A call has been added to a queue and the Enqueue command’s notificationUrl is being invoked.
     *
     * @return self
     */
    ...
    public static function deserialize(string $payload) {
        ...
        return ObjectSerializer::deserialize($content, '\FreeClimb\Api\Model\AddToQueueNotificationWebhook', []);
    }
}
