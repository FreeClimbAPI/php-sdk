...
class SMSTenDLCCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'csp_id' => 'string',
        'reseller_id' => 'string',
        'status' => '\FreeClimb\Api\Model\SMSTenDLCCampaignStatus',
    ...
    protected static array $openAPINullables = [
        ...
        'reference_id' => true,
        'mock' => false,
        'next_renewal_or_expiration_date' => true
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('billed_date', $data ?? [], null);
        ...
        $this->setIfExists('next_renewal_or_expiration_date', $data ?? [], null);
    }
    ...
    */
    ...
    public function setResellerId($reseller_id)
    {
        if (is_null($reseller_id)) {
            array_push($this->openAPINullablesSetToNull, 'reseller_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reseller_id', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets status
     *
     * @return \FreeClimb\Api\Model\SMSTenDLCCampaignStatus|null
     */
     ...
     * Sets status
     *
     * @param \FreeClimb\Api\Model\SMSTenDLCCampaignStatus|null $status status
     *
     * @return self
     */
    ...
    {
        if (is_null($billed_date)) {
            array_push($this->openAPINullablesSetToNull, 'billed_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('billed_date', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setReferenceId($reference_id)
    {
        if (is_null($reference_id)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reference_id', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($next_renewal_or_expiration_date)) {
            array_push($this->openAPINullablesSetToNull, 'next_renewal_or_expiration_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('next_renewal_or_expiration_date', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
