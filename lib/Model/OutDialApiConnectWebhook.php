...
/**
 * OutDialApiConnectWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class OutDialApiConnectWebhook extends Webhook
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutDialApiConnectWebhook';
    ...
    */
     ...
     * Sets request_type
     *
     * @param string|null $request_type Context or reason why this request is being made. Will be outDialApiConnect - An outbound call spawned by the REST API has connected and the callConnectUrl specified in the API request is being invoked.
     *
     * @return self
     */
    ...
    public static function deserialize(string $payload) {
        ...
        return ObjectSerializer::deserialize($content, '\FreeClimb\Api\Model\OutDialApiConnectWebhook', []);
    }
}
