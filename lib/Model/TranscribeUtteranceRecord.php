...
/**
 * TranscribeUtteranceRecord Class Doc Comment
 *
 * @category Class
 * @package  FreeClimb\Api
 * @author   OpenAPI Generator team
 ...
 */
class TranscribeUtteranceRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TranscribeUtteranceRecord';
    ...
    protected static array $openAPINullables = [
        ...
        'rcrd_termination_silence_time_ms' => false
    ];
    ...
    {
        $this->setIfExists('save_recording', $data ?? [], false);
        $this->setIfExists('max_length_sec', $data ?? [], 60);
        $this->setIfExists('rcrd_termination_silence_time_ms', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['rcrd_termination_silence_time_ms']) && ($this->container['rcrd_termination_silence_time_ms'] < 1)) {
            $invalidProperties[] = "invalid value for 'rcrd_termination_silence_time_ms', must be bigger than or equal to 1.";
        }
    ...
    {
        if (is_null($save_recording)) {
            throw new \InvalidArgumentException('non-nullable save_recording cannot be null');
        }
    ...
    public function setMaxLengthSec($max_length_sec)
    {
        ...
        if (($max_length_sec > 60)) {
            throw new \InvalidArgumentException('invalid value for $max_length_sec when calling TranscribeUtteranceRecord., must be smaller than or equal to 60.');
        }
        if (($max_length_sec < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_length_sec when calling TranscribeUtteranceRecord., must be bigger than or equal to 1.');
        }
    ...
    {
        if (is_null($rcrd_termination_silence_time_ms)) {
            throw new \InvalidArgumentException('non-nullable rcrd_termination_silence_time_ms cannot be null');
        }

        if (($rcrd_termination_silence_time_ms > 3000)) {
            throw new \InvalidArgumentException('invalid value for $rcrd_termination_silence_time_ms when calling TranscribeUtteranceRecord., must be smaller than or equal to 3000.');
        }
        if (($rcrd_termination_silence_time_ms < 1)) {
            throw new \InvalidArgumentException('invalid value for $rcrd_termination_silence_time_ms when calling TranscribeUtteranceRecord., must be bigger than or equal to 1.');
        }
