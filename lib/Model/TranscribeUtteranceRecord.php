...
class TranscribeUtteranceRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TranscribeUtterance_record';
    ...
    public function setRcrdTerminationSilenceTimeMs($rcrd_termination_silence_time_ms)
    {
        ...
        if (!is_null($rcrd_termination_silence_time_ms) && ($rcrd_termination_silence_time_ms <= 0)) {
            throw new \InvalidArgumentException('invalid value for $rcrd_termination_silence_time_ms when calling TranscribeUtteranceRecord., must be bigger than 0.');
        }
