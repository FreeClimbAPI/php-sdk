...
/**
 * GetDigitsWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class GetDigitsWebhook extends Webhook
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetDigitsWebhook';
    ...
    protected static $openAPITypes = [
        ...
        'queue_id' => 'string',
        'digits' => 'string',
        'reason' => '\FreeClimb\Api\Model\GetDigitsReason',
    ...
    */
     ...
     * Sets request_type
     *
     * @param string|null $request_type Context or reason why this request is being made. Will be getDigits - The GetDigits command has completed and its actionUrl is being invoked.
     *
     * @return self
     */
     ...
     * Sets digits
     *
     * @param string|null $digits tring of digits entered by the Caller, excluding the terminating digit (if used). The string of digits will be replaced by 'xxxxx' when privacyMode is set to true
     *
     * @return self
     */
     ...
     * Gets reason
     *
     * @return \FreeClimb\Api\Model\GetDigitsReason|null
     */
     ...
     * Sets reason
     *
     * @param \FreeClimb\Api\Model\GetDigitsReason|null $reason reason
     *
     * @return self
     */
    ...
    public static function deserialize(string $payload) {
        ...
        return ObjectSerializer::deserialize($content, '\FreeClimb\Api\Model\GetDigitsWebhook', []);
    }
}
