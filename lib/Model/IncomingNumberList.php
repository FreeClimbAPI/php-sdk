...
class IncomingNumberList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('incoming_phone_numbers', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($incoming_phone_numbers)) {
            array_push($this->openAPINullablesSetToNull, 'incoming_phone_numbers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('incoming_phone_numbers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
