...
/**
 * InboundCallWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class InboundCallWebhook extends Webhook
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InboundCallWebhook';
    ...
    */
     ...
     * Sets request_type
     *
     * @param string|null $request_type Context or reason why this request is being made. Will be inboundCall - An inbound call was received and the voiceUrl is being invoked.
     *
     * @return self
     */
    ...
    public static function deserialize(string $payload)
    {
        ...
        return ObjectSerializer::deserialize($content, '\FreeClimb\Api\Model\InboundCallWebhook', []);
    }
}
