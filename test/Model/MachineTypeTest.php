...
public function test_ANSWERING_MACHINE_should_deserialize_to_string() {
    $test = MachineType::ANSWERING_MACHINE;
    $this->assertEquals($test, 'answeringMachine');
}


public function test_FAX_MACHINE_should_deserialize_to_string() {
    $test = MachineType::FAX_MACHINE;
    $this->assertEquals($test, 'faxMachine');
}
