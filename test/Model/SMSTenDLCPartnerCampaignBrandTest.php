...
class SMSTenDLCPartnerCampaignBrandTest extends TestCase
{
    ...
    public function testPropertyOptionalAttributes()
    {
        ...
        $this->assertIsObject($this->SMSTenDLCPartnerCampaignBrand->getOptionalAttributes());
    }
    /**
    ...
    public function testPropertyEvpVettingScore()
    {
        ...
        $this->assertEquals($this->SMSTenDLCPartnerCampaignBrand->getEvpVettingScore(), 12345);
