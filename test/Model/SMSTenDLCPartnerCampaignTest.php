...
class SMSTenDLCPartnerCampaignTest extends TestCase
{
    ...
    public function testPropertyAccountId()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getAccountId(), 'TEST_STRING');
    ...
    public function testPropertyCampaignId()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getCampaignId(), 'TEST_STRING');
    ...
    public function testPropertyStatus()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getStatus(), 'ACTIVE');
    ...
    {
        $this->SMSTenDLCPartnerCampaign->setBrandId('TEST');
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getBrandId(), 'TEST');
    ...
    public function testPropertyUsecase()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getUsecase(), 'TEST_STRING');
    ...
    public function testPropertyDescription()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getDescription(), 'TEST_STRING');
    ...
    public function testPropertyEmbeddedLink()
    {
        ...
        $this->assertEquals($this->SMSTenDLCPartnerCampaign->getEmbeddedLink(), true);
    ...
    public function testPropertyEmbeddedPhone()
    {
        ...
        $this->assertEquals($this->SMSTenDLCPartnerCampaign->getEmbeddedPhone(), true);
    ...
    public function testPropertyAffiliateMarketing()
    {
        ...
        $this->assertEquals($this->SMSTenDLCPartnerCampaign->getAffiliateMarketing(), true);
    ...
    public function testPropertyNumberPool()
    {
        ...
        $this->assertEquals($this->SMSTenDLCPartnerCampaign->getNumberPool(), true);
    ...
    public function testPropertyAgeGated()
    {
        ...
        $this->assertEquals($this->SMSTenDLCPartnerCampaign->getAgeGated(), true);
    ...
    public function testPropertyDirectLending()
    {
        ...
        $this->assertEquals($this->SMSTenDLCPartnerCampaign->getDirectLending(), true);
    ...
    public function testPropertySubscriberOptin()
    {
        ...
        $this->assertEquals($this->SMSTenDLCPartnerCampaign->getSubscriberOptin(), true);
    ...
    public function testPropertySubscriberOptout()
    {
        ...
        $this->assertEquals($this->SMSTenDLCPartnerCampaign->getSubscriberOptout(), true);
    ...
    public function testPropertySubscriberHelp()
    {
        ...
        $this->assertEquals($this->SMSTenDLCPartnerCampaign->getSubscriberHelp(), true);
    ...
    public function testPropertySample1()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getSample1(), 'TEST_STRING');
    ...
    public function testPropertySample2()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getSample2(), 'TEST_STRING');
    ...
    public function testPropertySample3()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getSample3(), 'TEST_STRING');
    ...
    public function testPropertySample4()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getSample4(), 'TEST_STRING');
    ...
    public function testPropertySample5()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getSample5(), 'TEST_STRING');
    ...
    public function testPropertyMessageFlow()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getMessageFlow(), 'TEST_STRING');
    ...
    public function testPropertyHelpMessage()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getHelpMessage(), 'TEST_STRING');
    ...
    public function testPropertyOptinKeywords()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getOptinKeywords(), 'TEST_STRING');
    ...
    public function testPropertyOptoutKeywords()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getOptoutKeywords(), 'TEST_STRING');
    ...
    public function testPropertyHelpKeywords()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getHelpKeywords(), 'TEST_STRING');
    ...
    public function testPropertyOptinMessage()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getOptinMessage(), 'TEST_STRING');
    ...
    public function testPropertyOptoutMessage()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCPartnerCampaign->getOptoutMessage(), 'TEST_STRING');
    ...
    public function testPropertyBrand()
    {
        ...
        $this->assertIsObject($this->SMSTenDLCPartnerCampaign->getBrand());
    }
}