...
class TranscribeUtteranceTest extends TestCase
{
    ...
    public function testPropertyActionUrl()
    {
        ...
        $this->assertStringContainsString($this->TranscribeUtterance->getActionUrl(), 'TEST_STRING');
    ...
    public function testPropertyPlayBeep()
    {
        ...
        $this->assertEquals($this->TranscribeUtterance->getPlayBeep(), true);
    ...
    public function testPropertyRecord()
    {
        ...
        $this->assertIsObject($this->TranscribeUtterance->getRecord());
    }
    /**
    ...
    public function testPropertyPrivacyForLogging()
    {
        ...
        $this->assertEquals($this->TranscribeUtterance->getPrivacyForLogging(), true);
    ...
    public function testPropertyPrivacyForRecording()
    {
        ...
        $this->assertEquals($this->TranscribeUtterance->getPrivacyForRecording(), true);
    ...
    {
        $this->TranscribeUtterance->setPrompts(array());
