...
use FreeClimb\Api\Model\MachineDetectedWebhook;
...
{
    protected $MachineDetectedWebhook;
...
public function toStringTest() {
    $test1 = new MachineDetectedWebhook();    
    ...
    $test1->setMachineType(\FreeClimb\Api\Model\MachineType::ANSWERING_MACHINE);
