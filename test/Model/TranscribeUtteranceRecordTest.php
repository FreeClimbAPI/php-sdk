...
class TranscribeUtteranceRecordTest extends TestCase
{
    ...
    public function testPropertySaveRecording()
    {
        ...
        $this->assertEquals($this->TranscribeUtteranceRecord->getSaveRecording(), true);
    ...
    public function testPropertyMaxLengthSec()
    {
        ...
        $this->assertEquals($this->TranscribeUtteranceRecord->getMaxLengthSec(), 60);
    ...
    public function testPropertyRcrdTerminationSilenceTimeMs()
    {
        ...
        $this->assertEquals($this->TranscribeUtteranceRecord->getRcrdTerminationSilenceTimeMs(), 3000);
