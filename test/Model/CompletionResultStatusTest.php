...
{
    protected $CompletionResultStatus;
...
public function test_SUCCESS_should_deserialize_to_string() {
    $test = CompletionResultStatus::SUCCESS;
    $this->assertEquals($test, 'success');
}


public function test_NO_CONTEXT_should_deserialize_to_string() {
    $test = CompletionResultStatus::NO_CONTEXT;
    $this->assertEquals($test, 'no_context');
}
