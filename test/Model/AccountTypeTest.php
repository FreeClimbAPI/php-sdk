...
public function test_TRIAL_should_deserialize_to_string() {
    $test = AccountType::TRIAL;
    $this->assertEquals($test, 'trial');
}


public function test_FULL_should_deserialize_to_string() {
    $test = AccountType::FULL;
    $this->assertEquals($test, 'full');
}
