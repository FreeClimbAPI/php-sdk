...
class SMSTenDLCCampaignsListResultTest extends TestCase
{
    ...
    public function testPropertyTotal()
    {
        ...
        $this->assertEquals($this->SMSTenDLCCampaignsListResult->getTotal(), 12345);
    ...
    public function testPropertyStart()
    {
        ...
        $this->assertEquals($this->SMSTenDLCCampaignsListResult->getStart(), 12345);
    ...
    public function testPropertyEnd()
    {
        ...
        $this->assertEquals($this->SMSTenDLCCampaignsListResult->getEnd(), 12345);
    ...
    public function testPropertyPage()
    {
        ...
        $this->assertEquals($this->SMSTenDLCCampaignsListResult->getPage(), 12345);
    ...
    public function testPropertyNumPages()
    {
        ...
        $this->assertEquals($this->SMSTenDLCCampaignsListResult->getNumPages(), 12345);
    ...
    public function testPropertyPageSize()
    {
        ...
        $this->assertEquals($this->SMSTenDLCCampaignsListResult->getPageSize(), 12345);
    ...
    public function testPropertyNextPageUri()
    {
        ...
        $this->assertStringContainsString($this->SMSTenDLCCampaignsListResult->getNextPageUri(), 'TEST_STRING');
