...
class DefaultApiTest extends TestCase
{
    ...
    public function testBuyAPhoneNumber()
    {
        ...
        $response = this->$apiInstance->buyAPhoneNumber($this->buy_incoming_number_request_buyAPhoneNumber_test_value());
    ...
    public function testCreateAConference()
    {
        ...
        $response = this->$apiInstance->createAConference($this->create_conference_request_createAConference_test_value());
    ...
    public function testCreateAQueue()
    {
        ...
        $response = this->$apiInstance->createAQueue($this->queue_request_createAQueue_test_value());
    ...
    public function testCreateAnApplication()
    {
        ...
        $response = this->$apiInstance->createAnApplication($this->application_request_createAnApplication_test_value());
    ...
    public function testCreateKnowledgeBaseCompletion()
    {
        ...
        $response = this->$apiInstance->createKnowledgeBaseCompletion($this->knowledge_base_id_createKnowledgeBaseCompletion_test_value(), $this->completion_request_createKnowledgeBaseCompletion_test_value());
    ...
    public function testDeleteARecording()
    {
        ...
        $response = this->$apiInstance->deleteARecording($this->recording_id_deleteARecording_test_value());
    ...
    public function testDeleteAnApplication()
    {
        ...
        $response = this->$apiInstance->deleteAnApplication($this->application_id_deleteAnApplication_test_value());
        $this->assertNull($response);
    }
    ...
    public function testDeleteAnIncomingNumber()
    {
        ...
        $response = this->$apiInstance->deleteAnIncomingNumber($this->phone_number_id_deleteAnIncomingNumber_test_value());
        $this->assertNull($response);
    }
    ...
    public function testDequeueAMember()
    {
        ...
        $response = this->$apiInstance->dequeueAMember($this->queue_id_dequeueAMember_test_value(), $this->call_id_dequeueAMember_test_value());
    ...
    public function testDequeueHeadMember()
    {
        ...
        $response = this->$apiInstance->dequeueHeadMember($this->queue_id_dequeueHeadMember_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\QueueMember',$response);
    }
    ...
    public function testDownloadARecordingFile()
    {
        ...
        $response = this->$apiInstance->downloadARecordingFile($this->recording_id_downloadARecordingFile_test_value());
    ...
    public function testFilterLogs()
    {
        ...
        $response = this->$apiInstance->filterLogs($this->filter_logs_request_filterLogs_test_value());
    ...
    public function testGetACall()
    {
        ...
        $response = this->$apiInstance->getACall($this->call_id_getACall_test_value());
    ...
    public function testGetAConference()
    {
        ...
        $response = this->$apiInstance->getAConference($this->conference_id_getAConference_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\ConferenceResult',$response);
    }
    ...
    public function testGetAMember()
    {
        ...
        $response = this->$apiInstance->getAMember($this->queue_id_getAMember_test_value(), $this->call_id_getAMember_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\QueueMember',$response);
    }
    ...
    public function testGetAParticipant()
    {
        ...
        $response = this->$apiInstance->getAParticipant($this->conference_id_getAParticipant_test_value(), $this->call_id_getAParticipant_test_value());
    ...
    public function testGetAQueue()
    {
        ...
        $response = this->$apiInstance->getAQueue($this->queue_id_getAQueue_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\QueueResult',$response);
    }
    ...
    public function testGetARecording()
    {
        ...
        $response = this->$apiInstance->getARecording($this->recording_id_getARecording_test_value());
    ...
    public function testGetAnAccount()
    {
        ...
        $response = this->$apiInstance->getAnAccount();
    ...
    public function testGetAnApplication()
    {
        ...
        $response = this->$apiInstance->getAnApplication($this->application_id_getAnApplication_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\ApplicationResult',$response);
    }
    ...
    public function testGetAnIncomingNumber()
    {
        ...
        $response = this->$apiInstance->getAnIncomingNumber($this->phone_number_id_getAnIncomingNumber_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\IncomingNumberResult',$response);
    }
    ...
    public function testGetAnSmsMessage()
    {
        ...
        $response = this->$apiInstance->getAnSmsMessage($this->message_id_getAnSmsMessage_test_value());
    ...
    public function testGetHeadMember()
    {
        ...
        $response = this->$apiInstance->getHeadMember($this->queue_id_getHeadMember_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\QueueMember',$response);
    }
    ...
    public function testGetTenDLCSmsBrand()
    {
        ...
        $response = this->$apiInstance->getTenDLCSmsBrand($this->brand_id_getTenDLCSmsBrand_test_value());
    ...
    public function testGetTenDLCSmsBrands()
    {
        ...
        $response = this->$apiInstance->getTenDLCSmsBrands();
    ...
    public function testGetTenDLCSmsCampaign()
    {
        ...
        $response = this->$apiInstance->getTenDLCSmsCampaign($this->campaign_id_getTenDLCSmsCampaign_test_value());
    ...
    public function testGetTenDLCSmsCampaigns()
    {
        ...
        $response = this->$apiInstance->getTenDLCSmsCampaigns($this->brand_id_getTenDLCSmsCampaigns_test_value());
    ...
    public function testGetTenDLCSmsPartnerCampaign()
    {
        ...
        $response = this->$apiInstance->getTenDLCSmsPartnerCampaign($this->campaign_id_getTenDLCSmsPartnerCampaign_test_value());
    ...
    public function testGetTenDLCSmsPartnerCampaigns()
    {
        ...
        $response = this->$apiInstance->getTenDLCSmsPartnerCampaigns($this->brand_id_getTenDLCSmsPartnerCampaigns_test_value());
    ...
    public function testGetTollFreeSmsCampaign()
    {
        ...
        $response = this->$apiInstance->getTollFreeSmsCampaign($this->campaign_id_getTollFreeSmsCampaign_test_value());
    ...
    public function testGetTollFreeSmsCampaigns()
    {
        ...
        $response = this->$apiInstance->getTollFreeSmsCampaigns();
    ...
    public function testListActiveQueues()
    {
        ...
        $response = this->$apiInstance->listActiveQueues($this->alias_listActiveQueues_test_value());
    ...
    public function testListAllAccountLogs()
    {
        ...
        $response = this->$apiInstance->listAllAccountLogs();
        $this->assertInstanceOf('\FreeClimb\Api\Model\LogList',$response);
    }
    ...
    public function testListApplications()
    {
        ...
        $response = this->$apiInstance->listApplications($this->alias_listApplications_test_value());
    ...
    public function testListCallLogs()
    {
        ...
        $response = this->$apiInstance->listCallLogs($this->call_id_listCallLogs_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\LogList',$response);
    }
    ...
    public function testListCallRecordings()
    {
        ...
        $response = this->$apiInstance->listCallRecordings($this->call_id_listCallRecordings_test_value(), $this->date_created_listCallRecordings_test_value());
    ...
    public function testListConferenceRecordings()
    {
        ...
        $response = this->$apiInstance->listConferenceRecordings($this->conference_id_listConferenceRecordings_test_value(), $this->call_id_listConferenceRecordings_test_value(), $this->date_created_listConferenceRecordings_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\RecordingList',$response);
    }
    ...
    public function testListConferences()
    {
        ...
        $response = this->$apiInstance->listConferences($this->status_listConferences_test_value(), $this->alias_listConferences_test_value(), $this->date_created_listConferences_test_value(), $this->date_updated_listConferences_test_value());
    ...
    public function testListMembers()
    {
        ...
        $response = this->$apiInstance->listMembers($this->queue_id_listMembers_test_value());
    ...
    public function testListParticipants()
    {
        ...
        $response = this->$apiInstance->listParticipants($this->conference_id_listParticipants_test_value(), $this->talk_listParticipants_test_value(), $this->listen_listParticipants_test_value(), $this->dtmf_pass_through_listParticipants_test_value());
    ...
    public function testListRecordings()
    {
        ...
        $response = this->$apiInstance->listRecordings($this->call_id_listRecordings_test_value(), $this->conference_id_listRecordings_test_value(), $this->date_created_listRecordings_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\RecordingList',$response);
    }
    ...
    public function testListSmsMessages()
    {
        ...
        $response = this->$apiInstance->listSmsMessages($this->to_listSmsMessages_test_value(), $this->from_listSmsMessages_test_value(), $this->begin_time_listSmsMessages_test_value(), $this->end_time_listSmsMessages_test_value(), $this->direction_listSmsMessages_test_value(), $this->campaign_id_listSmsMessages_test_value(), $this->brand_id_listSmsMessages_test_value(), $this->is10_dlc_listSmsMessages_test_value());
    ...
    public function testMakeACall()
    {
        ...
        $response = this->$apiInstance->makeACall($this->make_call_request_makeACall_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\CallResult',$response);
    }
    ...
    public function testMakeAWebrtcJwt()
    {
        ...
        $response = this->$apiInstance->makeAWebrtcJwt($this->create_web_rtc_token_makeAWebrtcJwt_test_value());
    ...
    public function testRemoveAParticipant()
    {
        ...
        $response = this->$apiInstance->removeAParticipant($this->conference_id_removeAParticipant_test_value(), $this->call_id_removeAParticipant_test_value());
        $this->assertNull($response);
    }
    ...
    public function testSendAnSmsMessage()
    {
        ...
        $response = this->$apiInstance->sendAnSmsMessage($this->message_request_sendAnSmsMessage_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\MessageResult',$response);
    }
    ...
    public function testStreamARecordingFile()
    {
        ...
        $response = this->$apiInstance->streamARecordingFile($this->recording_id_streamARecordingFile_test_value());
        $this->assertInstanceOf('\SplFileObject',$response);
    }
    ...
    public function testUpdateAConference()
    {
        ...
        $response = this->$apiInstance->updateAConference($this->conference_id_updateAConference_test_value(), $this->update_conference_request_updateAConference_test_value());
        $this->assertNull($response);
    }
    ...
    public function testUpdateALiveCall()
    {
        ...
        $response = this->$apiInstance->updateALiveCall($this->call_id_updateALiveCall_test_value(), $this->update_call_request_updateALiveCall_test_value());
        $this->assertNull($response);
    }
    ...
    public function testUpdateAParticipant()
    {
        ...
        $response = this->$apiInstance->updateAParticipant($this->conference_id_updateAParticipant_test_value(), $this->call_id_updateAParticipant_test_value(), $this->update_conference_participant_request_updateAParticipant_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\ConferenceParticipantResult',$response);
    }
    ...
    public function testUpdateAQueue()
    {
        ...
        $response = this->$apiInstance->updateAQueue($this->queue_id_updateAQueue_test_value(), $this->queue_request_updateAQueue_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\QueueResult',$response);
    }
    ...
    public function testUpdateAnAccount()
    {
        ...
        $response = this->$apiInstance->updateAnAccount($this->account_request_updateAnAccount_test_value());
        $this->assertNull($response);
    }
    ...
    public function testUpdateAnApplication()
    {
        ...
        $response = this->$apiInstance->updateAnApplication($this->application_id_updateAnApplication_test_value(), $this->application_request_updateAnApplication_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\ApplicationResult',$response);
    }
    ...
    public function testUpdateAnIncomingNumber()
    {
        ...
        $response = this->$apiInstance->updateAnIncomingNumber($this->phone_number_id_updateAnIncomingNumber_test_value(), $this->incoming_number_request_updateAnIncomingNumber_test_value());
        $this->assertInstanceOf('\FreeClimb\Api\Model\IncomingNumberResult',$response);
    }
}
